...
// ============================================================
// ConsentModal.tsx – Modal de Consentimientos LOPDP Ecuador
...
const TERMS_TEXT = `
TÉRMINOS Y CONDICIONES DE USO – ChargeWay
...
const PRIVACY_TEXT = `
POLÍTICA DE PRIVACIDAD – ChargeWay
Versión 1.0 | Vigente desde: junio 2025
...
3.2 FINALIDADES ESTADÍSTICAS CON ANONIMIZACIÓN (base legal: interés legítimo + consentimiento):
Los datos de movilidad son sometidos a un proceso técnico de ANONIMIZACIÓN IRREVERSIBLE, conforme a la Resolución No. SPDP-SPD-2025-0030-R, antes de ser compartidos en los siguientes dashboards:
...
const ExpandableDoc: React.FC<{ title: string; content: string }> = ({ title, content }) => {
